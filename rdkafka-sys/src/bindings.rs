...
pub const RD_KAFKA_VERSION: i32 = 34211327;
...
pub struct rd_kafka_avg_stats_s {
    pub min: i64,
    pub max: i64,
    pub avg: i64,
    pub sum: i64,
...
pub type rd_kafka_avg_stats_t = rd_kafka_avg_stats_s;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct rd_kafka_partition_stats_s {
    pub partition: i32,
    pub broker_id: i32,
    pub leader: i32,
    pub desired: i8,
...
pub type rd_kafka_partition_stats_t = rd_kafka_partition_stats_s;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct rd_kafka_topic_stats_s {
    pub name: [c_char; 256usize],
    pub age_us: i64,
    pub metadata_age_us: i64,
    pub batchsize: rd_kafka_avg_stats_t,
    pub batchcnt: rd_kafka_avg_stats_t,
    pub partition_cnt: u32,
    pub _pad: u32,
    pub partitions: *mut rd_kafka_partition_stats_t,
}
pub type rd_kafka_topic_stats_t = rd_kafka_topic_stats_s;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct rd_kafka_broker_toppar_ref_s {
    pub topic: [c_char; 256usize],
    pub partition: i32,
    pub _pad: i32,
}
pub type rd_kafka_broker_toppar_ref_t = rd_kafka_broker_toppar_ref_s;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct rd_kafka_req_count_s {
    pub name: [c_char; 32usize],
    pub count: i64,
}
pub type rd_kafka_req_count_t = rd_kafka_req_count_s;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct rd_kafka_broker_stats_s {
    pub name: [c_char; 256usize],
    pub nodeid: i32,
    pub nodename: [c_char; 256usize],
    pub source: [c_char; 32usize],
    pub state: i32,
    pub stateage_us: i64,
    pub outbuf_cnt: i32,
    pub outbuf_msg_cnt: i32,
    ...
    pub connects: i64,
    pub disconnects: i64,
    pub int_latency: rd_kafka_avg_stats_t,
    pub outbuf_latency: rd_kafka_avg_stats_t,
    pub rtt: rd_kafka_avg_stats_t,
    pub throttle: rd_kafka_avg_stats_t,
    pub produce_partitions: rd_kafka_avg_stats_t,
    pub produce_messages: rd_kafka_avg_stats_t,
    pub produce_reqsize: rd_kafka_avg_stats_t,
    pub produce_fill: rd_kafka_avg_stats_t,
    pub batch_wait: rd_kafka_avg_stats_t,
    pub adaptive_enabled: i8,
    pub _pad_adaptive: [i8; 7usize],
    pub adaptive_linger_us: i64,
    pub adaptive_batch_max_bytes: i64,
    pub adaptive_congestion: f64,
    pub adaptive_rtt_congestion: f64,
    pub adaptive_int_lat_congestion: f64,
    pub adaptive_rtt_base_us: i64,
    pub adaptive_rtt_current_us: i64,
    pub adaptive_int_lat_base_us: i64,
    ...
    pub toppar_cnt: u32,
    pub _pad: u32,
    pub toppars: *mut rd_kafka_broker_toppar_ref_t,
}
pub type rd_kafka_broker_stats_t = rd_kafka_broker_stats_s;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct rd_kafka_cgrp_stats_s {
    pub state: i32,
    pub stateage_us: i64,
    pub join_state: i32,
    pub rebalance_age_us: i64,
    pub rebalance_cnt: i32,
    pub rebalance_reason: [c_char; 256usize],
    pub assignment_size: i32,
    pub _pad: i32,
}
pub type rd_kafka_cgrp_stats_t = rd_kafka_cgrp_stats_s;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct rd_kafka_eos_stats_s {
    pub idemp_state: i32,
    pub idemp_stateage_us: i64,
    pub txn_state: i32,
    pub txn_stateage_us: i64,
    pub txn_may_enq: i8,
    pub _pad: [i8; 3usize],
    pub producer_id: i64,
...
pub type rd_kafka_eos_stats_t = rd_kafka_eos_stats_s;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct rd_kafka_stats_s {
    pub name: [c_char; 256usize],
    pub client_id: [c_char; 256usize],
    pub type_: i32,
    pub _pad: i32,
    pub ts_us: i64,
    pub time_sec: i64,
    ...
    pub broker_cnt: u32,
    pub _pad2: u32,
    pub brokers: *mut rd_kafka_broker_stats_t,
    pub topic_cnt: u32,
    pub _pad3: u32,
    pub topics: *mut rd_kafka_topic_stats_t,
    pub has_cgrp: i8,
    pub _pad4: [i8; 7usize],
    pub cgrp: rd_kafka_cgrp_stats_t,
    pub has_eos: i8,
    pub _pad5: [i8; 7usize],
    pub eos: rd_kafka_eos_stats_t,
    pub has_fatal: i8,
    pub _pad6: [i8; 3usize],
    pub fatal_err: i32,
    pub fatal_reason: [c_char; 512usize],
    pub fatal_cnt: i32,
    pub _pad7: i32,
}
pub type rd_kafka_stats_t = rd_kafka_stats_s;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
unsafe extern "C" {
    pub fn rd_kafka_conf_set_stats_cb_typed(
        conf: *mut rd_kafka_conf_t,
        stats_cb: Option<
            unsafe extern "C" fn(
                rk: *mut rd_kafka_t,
                stats: *const rd_kafka_stats_t,
                opaque: *mut c_void,
            ),
        >,
    );
